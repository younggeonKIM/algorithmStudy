...
//	출력으로 홍익대학교의 개교 주년을 나타내는 정수를 출력한다.
	...
	public static void main(String[] args) {
		...
		// openYear = 1946
		BigDecimal opYear = new BigDecimal("1946");
		// get HongikUniversity's anniversary by N subtracted by 1946
		BigDecimal var = now.subtract(opYear);
		// print integer that represents HongikUniversity's anniversary
