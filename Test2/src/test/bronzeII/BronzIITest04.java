...
public class BronzIITest04 {
	...
	public static void main(String[] args) {
		...
		int fxCo = Integer.parseInt(inputArr[0]);
		int varCo = Integer.parseInt(inputArr[1]);
		int pricePerVol = Integer.parseInt(inputArr[2]);
		int resVol = (fxCo / (pricePerVol -varCo))+1;
		
		if ( pricePerVol - varCo < 0) {
